...
static const NSTimeInterval CSToastFadeDuration = 0.4;
      ...
      tapCallback:(void(^)(void))tapCallback
{
   ...
   // UIWindow *win=[UIApplication sharedApplication].windows ;
    //NSLog(@"%@",[[UIApplication sharedApplication].windows lastObject].subviews);
...
-(void)makeWindowToast:(NSString *)message
{
    if (message != nil)
        return;
    UILabel *messageLabel = nil;
